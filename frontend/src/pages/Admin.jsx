      ...
      <div className="w-full flex flex-col">
        ...
        <div className="p-4 sm:ml-64">
          <div className="overflow-x-auto">
            ...
            <button onClick={downloadExcel} className="mt-4 px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600">
            Download as Excel
          </button>
          <br/>
              <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                  {tableData.map((data, index) => (
                    ...
                    >
                      <td className="font-bold text-black py-4 px-6 hidden sm:table-cell">{data.thickness}</td>
                      <td className="font-bold text-black py-4 px-6">{data.batterylevel}%</td>
                      <td className="font-bold text-black py-4 px-6">{data.devicetemp}°C</td>
                      <td className="font-bold text-black py-4 px-6">{data.signal}%</td>
                      <td className="font-bold text-black py-4 px-6">{data.createdAt}</td>
                    </tr>
                  ))}{" "}
                </tbody>
              </table>
