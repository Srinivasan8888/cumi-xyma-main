          ...
          <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            ...
            <tbody>
              {tableData.map((data, index) => (
                ...
                >
                  <td className="font-bold text-black py-4 px-6 hidden sm:table-cell">{(((data.thickness - 0) * (100 - 0)) / (data.inputthickness - 0)).toFixed(2)}</td>
                  ...
                  <td className="font-bold text-black py-4 px-6">{data.updatedAt}</td>
                </tr>
              ))}{" "}
            </tbody>
          </table>
